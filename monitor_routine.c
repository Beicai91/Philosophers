...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/20 11:40:03 by bcai              #+#    #+#             */
/*   Updated: 2024/06/20 12:08:25 by bcai             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_philo_status(t_philo *philo)
{
	...
	if ((get_current_time() * 1000 - simulation->start_time)
		- philo->meal_time > simulation->time_to_die)
	{
		philo->dead = true;
...
static int	philo_full(t_philo *philos)
{
	...
	while (++i < simulation->philo_nbr)
	{
		...
		if (philos[i].meals_eaten >= simulation->max_meal
